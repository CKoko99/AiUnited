...
const pageLinks = {
    ...
    optional: {
        id: "Optional",
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.AFFORDABLE}#Optional`,
    },
    penalties: {
        id: "Penalties",
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.AFFORDABLE}#Penalties`,
    },
};
...
const contentSection3 = {
    title: {
        en: "Minimum Insurance Requirements",
        es: "Requisitos mínimos de seguro",
    },
    subtitle: {
        en: [
...
export default function () {
    return (
        <>
            <HeadComponent
                title="Affordable Auto Coverage With Ai United Insurance"
