...
const pageLinks = {
    ...
    collision: {
        ...
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.COVERAGE}#Collision-Coverage`,
    },
    comprehensive: {
        id: "Comprehensive-Coverage",
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.COVERAGE}#Comprehensive-Coverage`,
    },
    pip: {
        id: "Personal-Injury-Protection",
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.COVERAGE}#Personal-Injury-Protection`,
    },
    umuim: {
        id: "Uninsured-UnderInsured-Coverage",
        link: `${PATHCONSTANTS.PRODUCTS.AUTO.COVERAGE}#Uninsured-UnderInsured-Coverage`,
    },
};
...
const contentSection2 = {
    title: {
        en: "Different Types of Auto Insurance Coverage",
        es: "Diferentes tipos de cobertura de seguro de auto",
    },
    body: {
        en: [
...
export default function () {
    return (
        <>
            <HeadComponent
                title={"Types of Auto Insurance Coverage"}
                metaData={
                    "Our comprehensive guide breaks down the details of auto insurance coverage, providing you with a roadmap to confidently choose the protection that suits you."
                }
            />
