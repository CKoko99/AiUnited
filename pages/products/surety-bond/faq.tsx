...
const headContent = {
    ...
    metaData:
        "Learn more about surety bond insurance and how it can protect you and your business. Get answers to frequently asked questions about surety bond insurance.",
};
