...
const pageLinks = {
    contract: {
        link: `${PATHCONSTANTS.PRODUCTS.SURETY.COVERAGE}#Contract`,
        id: "Contract",
    },
    commercial: {
        link: `${PATHCONSTANTS.PRODUCTS.SURETY.COVERAGE}#Commercial`,
        id: "Commercial",
    },
    court: {
        link: `${PATHCONSTANTS.PRODUCTS.SURETY.COVERAGE}#Court`,
        id: "Court",
    },
};
...
const contentSection2 = {
    title: {
        en: "Different Types of Bonds",
        es: "Diferentes tipos de fianzas",
    },
    body: {
        en: [
