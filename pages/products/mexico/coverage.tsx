...
const pageLinks = {
    definition: {
        link: `${PATHCONSTANTS.PRODUCTS.MEXICO.COVERAGE}#Definition`, id: "Definition"
    },
    liabilityCoverage: {
...
const contentSection5 = {
    ...
    subtitle: {
        en: [`Your well-being is our priority. Our insurance includes coverage for medical expenses resulting from an accident. Travel with peace of mind, knowing you have support in case of unforeseen medical costs.`],
        es: [`Su bienestar es nuestra prioridad. Nuestro seguro incluye cobertura de gastos médicos derivados de un accidente. Viaje con tranquilidad, sabiendo que cuenta con el respaldo en caso de gastos médicos imprevistos.`]
    },
    alignTitle: "left",
    alignSubtitle: "left",
}
