...
const headContent = {
    ...
    metaData: `Dive into the details of home insurance coverage with our overview. Explore detailed policies, including property, liability, and personal belongings coverage.`,
};
...
const contentSection2 = {
    title: {
        en: "Different Types of Home Insurance Coverage",
        es: "Diferentes tipos de cobertura de seguro de hogar",
    },
    body: {
        en: [
...
const contentSection4 = {
    title: {
        en: "Other Structures Coverage",
        es: "Cobertura de otras estructuras",
    },
