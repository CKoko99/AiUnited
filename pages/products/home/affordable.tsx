...
const pageLinks = {
    factors: {
        link: `${PATHCONSTANTS.PRODUCTS.HOME.COVERAGE}#Factors`, id: "Factors"
    },
    improving: {
        link: `${PATHCONSTANTS.PRODUCTS.HOME.COVERAGE}#Improving`, id: "Improving"
    },
    discounts: {
        link: `${PATHCONSTANTS.PRODUCTS.HOME.COVERAGE}#Discounts`, id: "Discounts"
    },
}
...
const contentSection2 = {
    title: {
        en: "Affordable Home Insurance coverage", es: "Cobertura de seguro de hogar asequible"
    },
    body: {
        en: [
...
const contentSection3 = {
    title: { en: "Factors Influencing Home Insurance Premiums", es: "Factores que influyen en las primas del seguro de hogar" },
...
const contentSection4 = {
    title: { en: "Improving Your Home Insurance Rates", es: "Mejorar sus tarifas de seguro de hogar" },
...
const contentSection6 = {
    title: { en: "Bundle Discounts for Maximum Savings", es: "Descuentos de paquetes para ahorros máximos" },
