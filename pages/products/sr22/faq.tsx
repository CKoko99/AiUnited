...
const headContent = {
    ...
    metaData: "Learn more about SR-22 insurance and how it can protect you and your business. Get answers to frequently asked questions about SR-22 insurance.",
}
