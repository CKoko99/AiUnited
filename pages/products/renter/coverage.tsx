...
const pageLinks = {
    personalProperty: {
        link: `${PATHCONSTANTS.PRODUCTS.RENTER.COVERAGE}#Personal-Property`, id: "Personal-Property"
    },
    liability: {
        link: `${PATHCONSTANTS.PRODUCTS.RENTER.COVERAGE}#Liability`, id: "Liability"
    },
    lossOfUse: {
        link: `${PATHCONSTANTS.PRODUCTS.RENTER.COVERAGE}#Loss-of-Use`, id: "Loss-of-Use"
    },
}
