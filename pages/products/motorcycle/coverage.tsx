...
const pageLinks = {
    liabilityCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#Liability-Coverage`,
        id: "Liability-Coverage",
    },
    collisionCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#Collision-Coverage`,
        id: "Collision-Coverage",
    },
    ComprehensizeCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#Comprehensive-Coverage`,
        id: "Comprehensive-Coverage",
    },
    uiuimCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#UIUIM-Coverage`,
        id: "UIUIM-Coverage",
    },
    medicalCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#Medical-Coverage`,
        id: "Medical-Coverage",
    },
    additionalCoverage: {
        link: `${PATHCONSTANTS.PRODUCTS.MOTORCYCLE.COVERAGE}#Additional-Coverage`,
...
const contentSection7 = {
    ...
    subtitle: {
        en: [
            `Medical coverage is crucial, providing financial assistance for your own medical expenses resulting from an accident, helping cover costs like hospital bills and rehabilitation.`,
        ],
        es: [
            `La cobertura médica es crucial, brindando asistencia financiera para sus propios gastos médicos resultantes de un accidente, ayudando a cubrir costos como facturas de hospitalización y rehabilitación.`,
        ],
    },
    alignTitle: "left",
    alignSubtitle: "left",
