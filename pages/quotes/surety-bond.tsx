...
const contentSection1 = {
    largeHorizontalCard: {
        ...
        body: {
            en: [
                `Surety Bond insurance is an essential safeguard that provides financial security and peace of mind. It 
            ...
            es: [
                `El seguro de fianza es una salvaguarda esencial que brinda seguridad financiera y tranquilidad. Éste seguro
...
const formContent = {
    ...
    subtitle: {
        en: "Start a free surety bond quote to see the savings.",
        es: `Comience una cotización gratuita de seguro de fianza para ver los ahorros`,
    },
    questions: [
        {
            subGroup: {
        ...
        {
            title: {
                en: "Years of experience in the field",
                es: "Años de experiencia en el campo",
            },
            type: "input",
            validation: "number",
            required: true,
        ...
        {
            title: {
                en: "How many additional owners are there?",
                es: "¿Cuántos propietarios adicionales hay?",
            },
            type: "input",
            validation: "number",
            required: true,
        ...
        {
            title: {
                en: "How many years have you been in business?",
                es: "¿Cuántos años lleva en el negocio?",
            },
            type: "input",
            validation: "number",
            required: true,
        ...
        {
            title: {
                en: "What is the amount of the bond you need?",
                es: "¿Cuál es la cantidad del bono que necesita?",
            },
            type: "input",
            validation: "number",
            required: true,
...
export default function () {
    return (
        <>
            <HeadComponent
                title={"Surety Bond | Get a Free Surety Bond Quote"}
                metaData={
                    "Get your free Surety Bond quote today with Ai United Insurance. Protect your business with confidence."
                }
            />
