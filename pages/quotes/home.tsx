...
const SimpleForm = dynamic(
    () => import("../../components/Forms/Simple/Simple"),
    { ssr: false },
);
...
const contentSection2 = {
    largeHorizontalCard: {
        ...
        body: {
            en: [
                `Home insurance covers your dwelling and belongings in case of damage or theft. Your home and the things you value are protected.            `,
        ...
        face a financial crisis if disaster strikes.`,
            ...
            es: [
                `El seguro de casa cubre su vivienda y sus pertenencias personales en caso de daños o robos. Esto significa que su casa
    ...
    largeVerticalCard: {
        body: {
            en: [
                "Join the thousands of people who switched to Ai United Insurance.",
            ],
            es: [
                "Únase a los miles de personas que cambiaron a Ai United Insurance",
            ],
        },
        img: {
            src: HomeImg2,
    ...
    smallCard2: {
        body: {
            ...
            es: [
                "Obtenga una cotización gratuita hoy desde la comodidad de su casa.",
            ],
        },
        CTA: {
            text: {
...
const contentSection3 = {
    ...
    body: {
        en: [
            `Your home represents your most valuable financial asset. Ai United Insurance we are committed to assisting you in insuring it.`,
        ...
        es: [
            `Su hogar representasu principal recurso financiero, y en Ai United Insurance estamos comprometidos en 
...
const formContent = {
    ...
    title: {
        ...
        es: "Cotización de Seguro de Casa",
    },
    subtitle: {
        en: "Start a free home insurance quote to see the savings.",
        es: `Comience una cotización gratuita de seguro de casa para ver los ahorros`,
    },
    questions: [
        {
            subGroup: {
        ...
        },
        {
            ...
            title: {
                ...
                es: "¿Es propietario o alquila esta propiedad?",
            },
            type: "radio",
            required: true,
            answers: [
        ...
        {
            title: {
                en: "Approximate year built",
                es: "Año de construcción aproximado",
            },
            outsideLabel: true,
            type: "input",
            required: true,
        ...
        {
            title: {
                en: "Have you reported any claims or losses within the past three years?",
                es: "¿Ha reportado algún reclamo o pérdida en los últimos 3 años?",
            },
            type: "radio",
            required: true,
            answers: [
...
export default function () {
    return (
        <>
            <HeadComponent
                title={"Home Insurance | Get a Free Home Insurance Quote"}
                metaData={
                    "Protect your haven! Get a free Home Insurance quote from Ai United Insurance today and safeguard your family's security."
                }
            />
