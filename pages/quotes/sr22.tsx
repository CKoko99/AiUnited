...
const contentSection2 = {
    ...
    body: {
        en: [
            `• **DUI/DWI Convictions:** If you've been convicted of a DUI or DWI, you'll likely need SR-22 insurance to 
        ...
        es: [
            `• **Condenas por DUI / DWI:** si ha sido condenado por un DUI o DWI, es probable que necesite un seguro SR-22 para
...
const contentSection3 = {
    largeHorizontalCard: {
        ...
        body: {
            en: [
                `When it comes to SR-22 insurance, you have some flexibility in choosing coverage options
            ...
            es: [
                `Cuando se trata de seguro SR-22, tiene cierta flexibilidad para elegir opciones de cobertura
...
const formContent = {
    ...
    spreadsheet: "Store 2",
    title: {
        en: "SR-22 Insurance Quote",
        es: "Cotización de Seguro de SR-22",
    },
    subtitle: {
        en: "Start a free SR-22 insurance quote to see the savings.",
        es: `Comience una cotización gratuita de seguro SR-22 para ver los ahorros`,
    },
    questions: [
        {
            subGroup: {
        ...
        {
            title: {
                en: "Do you currently have insurance?",
                es: "¿Tiene actualmente seguro?",
            },
            type: "radio",
            required: true,
            fullWidth: true,
...
export default function () {
    return (
        <>
            <HeadComponent
                title={"SR-22 Insurance | Get a Free SR-22 Insurance Quote"}
                metaData={
                    "Get your SR-22 insurance quote free! Ai United Insurance offers hassle-free solutions. Get covered today!"
                }
            />
