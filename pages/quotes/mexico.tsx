...
const contentSection1 = {
    largeHorizontalCard: {
        ...
        body: {
            en: [
                `Traveling to Mexico can be an exciting adventure, but it's essential to be prepared for the unexpected.`,
            ...
            es: [
                `Viajar a México puede ser una aventura emocionante, pero es esencial estar preparado para lo inesperado.`,
    ...
    largeVerticalCard: {
        body: {
            en: [
                `Ai United helps you find the best coverage during your travels.`,
            ],
            es: [
                `Ai United lo ayuda a encontrar la mejor cobertura durante sus viajes`,
            ],
        },
...
export default function () {
    return (
        <>
            <HeadComponent
                title={"Mexico Insurance | Get a Free Mexican Insurance Quote"}
                metaData={
                    "Embark on worry-free travels! Get your free Mexico Tourist Insurance quote with Ai United Insurance today and ensure a safe journey."
                }
            />
            ...
            >
                ...
                >
                    <Typography variant="h2">
                        {" "}
                        {returnLocaleText(quoteText.title)}{" "}
                    </Typography>
                    <Typography variant="h5">
                        {returnLocaleText(quoteText.subtitle)}
                    </Typography>
                </Box>
                <Box sx={{ width: "90%", margin: "auto", padding: "2rem" }}>
                    <iframe
                        id="Mexico-quote"
                        src="https://buy.mexipass.com/AIUN034"
                        height="800"
                        width="100%"
                    />
                </Box>
