...
const headContent = {
    ...
    metaData:
        "Make a payment on your insurance policy. Ai United Insurance provides you with coverage options, benefits and discounts at a price you can afford.",
};
        ...
        <>
            ...
            >
                <Typography component={"h1"} variant="h2">
                    {returnLocaleText(paymentText.payment)}
                </Typography>
                <Typography variant="h5">
                    {returnLocaleText(paymentText.enterPolicyNumber)}
                </Typography>
                <FormControl sx={{ display: "flex", flexDirection: "row" }}>
                    <TextField
                        label={returnLocaleText(paymentText.policyNumber)}
                        variant="outlined"
                        value={paymentInput}
                        ...
                        helperText={
                            error &&
                            returnLocaleText(paymentText.enterValidPolicyNumber)
                        }
                        style={{
                            width: "12rem",
                            backgroundColor: "white",
                ...
                {errorCount > 1 && !showAllProviders && (
                    <Button onClick={() => setShowAllProviders(true)}>
                        {returnLocaleText(paymentText.providerNotListed)}
                    </Button>
                )}
                ...
                {openModal && (
                    ...
                    >
                        <Box sx={{ ...styles.modal, textAlign: "center" }}>
                            <Typography variant="h5">
                                {returnLocaleText(paymentText.selectProvider)}
                            </Typography>
                            <Box
                                sx={{
                                    display: "flex",
