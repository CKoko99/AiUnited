...
const textContent = {
    content: [
        ...
        },
        {
            ...
            text: {
                en: [
                    `Work Full-time, Monday through Saturday, with availability spanning five days a week`,
                ...
                es: [
                    `Trabajar a tiempo completo, de lunes a sábado, con disponibilidad que abarque cinco días a la semana`,
