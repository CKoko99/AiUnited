...
const textContent = {
    content: [
        ...
        },
        {
            text: {
                en: [
                    `To effectively perform the duties of a Customer Service Representative/ Insurance agent, individuals must be able to 
            demonstrate a number of competencies that are essential to the position, which include:`,
                ],
                es: [
                    `Para desempeñar eficazmente las funciones de representante de servicio al cliente / agente de seguros, las personas deben poder
