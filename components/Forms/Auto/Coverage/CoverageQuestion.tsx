        ...
        coverages: [
            ...
            },
            {
                ...
                title: {
                    ...
                    es: "Daños a la Propiedad de un Conductor Sin Seguro",
                },
            },
            {
                ...
                title: {
                    ...
                    es: "Lesiones Corporales de un Conductor Sin Seguro",
                },
            },
            {
        ...
        coverages: [
            {
                ...
                options: [
                    {
                        value: "30000/60000",
                        text: { en: "30k/60k", es: "30k/60k" },
                    },
                    {
                        value: "50000/100000",
                        text: { en: "50k/100k", es: "50k/100k" },
                    },
                    {
                        value: "100000/300000",
                        text: { en: "100k/300k", es: "100k/300k" },
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                options: [{ value: 0, text: { en: "None", es: "Ninguno" } }],
                hidden: true,
            },
        ],
    },
...
function returnDefaultValues(
    defaultValue: Array<{ value: any; questionId: string; valid: boolean }>,
    options: number[],
) {
    ...
    for (let i = 0; i < options.length; i++) {
        ...
        defaultValue = defaultValue.filter(
            (coverage) => coverage.questionId !== "CoverageOption",
        );
        let match = true;
        ...
        if (match) {
            return {
                selectedIndex: options[i],
                selectedCoverageValues: defaultValue,
            };
        } else {
...
export default function (props: {
    ...
    const [selectedIndex, setSelectedIndex] = useState<number>(
        returnDefaultValues(props.formValues[props.id], props.options)
            .selectedIndex,
    );
    ...
    function setCoverageValuesHandler(
        index: number,
        values: { questionId: string; value: string | number | boolean }[],
    ) {
    ...
    useEffect(() => {
        if (selectedIndex === -1) {
            ...
            const name = {
                questionId: "CoverageOption",
                value: OPTIONS[selectedIndex].text.en,
                valid: true,
            };

            const selectedCoverageOptions = selectedCoverageValues.map(
                (coverage) => {
                    return {
                    ...
                    {OPTIONS.map((option, index) => {
                        ...
                        return (
                            <IndividualCoverage
                                ...
                                handleSelect={setCoverageValuesHandler}
                                {...OPTIONS[index]}
