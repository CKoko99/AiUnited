...
export default function SubNavBar(props: {
    ...
    content: { text: { [key: string]: string }; link: string }[];
}) {
    ...
    const handleMenuItemToggle = (label: any, event: any) => {
        ...
        setOpenItem((prevOpenItem: string | null) =>
            prevOpenItem === shortTitle ? null : shortTitle,
        );
    };
    return (
        <>
                ...
                >
                    <ListItem disablePadding>
                        <ListItemButton
                            sx={{ textAlign: "center" }}
                            onClick={(event) =>
                                handleMenuItemToggle(props.shortTitle, event)
                            }
                        >
                            <ListItemText
                                primary={
