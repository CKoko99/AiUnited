...
export default function Footer() {
                ...
                <Box sx={{ ...classes.section1 }}>
                    <Box sx={{ ...classes.logoImg }}>
                        <Image
                            ...
                            src={LogoImg}
                            alt="Ai United Insurance Logo"
                        />
                    </Box>
                    <Box sx={{ ...classes.section1content }}>
                        {/*
    ...
    */}
                        <Box>
                            ...
                            >
                                <LinkedInIcon sx={{ ...classes.socialIcon }} />
                            </a>
                            <a
                                href="https://twitter.com/aiunited?lang=en"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Visit AI United on Twitter"
                            >
                                <TwitterIcon sx={{ ...classes.socialIcon }} />
                            </a>
                            <a
                                href="https://www.facebook.com/AiUnitedInsurance"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Visit AI United on Facebook"
                            >
                                <FacebookIcon sx={{ ...classes.socialIcon }} />
                            </a>
                        </Box>
                    </Box>
                </Box>
                ...
                <Box sx={{ ...classes.section3 }}>
                    <Typography variant="body1">
                        {returnLocaleText(section3content.title)}
                    </Typography>
                                ...
                                <Box key={index}>
                                    <Link href={item.link}>
                                        <Typography
                                            ...
                                            sx={{ ...classes.link }}
                                        >
                                            {returnLocaleText(item.text)}{" "}
                                            {index !==
                                                section3content.links.length -
                                                    1 && "|"}
                                        </Typography>
                                    </Link>
                                </Box>
                ...
                >
                    <Button sx={{ color: "white" }} href={PATHCONSTANTS.TERMS}>
                        {returnLocaleText(text.terms)}
                    </Button>
                    |
                    <Button
                        sx={{ color: "white" }}
