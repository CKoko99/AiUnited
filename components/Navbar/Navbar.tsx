...
function DrawerAppBar(props: any) {
    ...
    const handleMenuItemToggle = (
        ...
        setOpenItem((prevOpenItem: { [lang: string]: string }) =>
            prevOpenItem === label ? null : label,
        );
    };
    ...
    const container =
        drawerWindow !== undefined
            ? () => drawerWindow().document.body
            : undefined;
                ...
                >
                    ...
                    >
                        {navItems.map((item, index) => {
                            if (item.main) {
                                return (
                                    <MainNavbarItem key={index} item={item} />
                                );
                            } else {
