...
export default function (props: Props) {
    return (
        <>
            {!props.hideTitle && <TextSection {...textContent} />}
            <Box sx={{ ...classes.root }}>
                    ...
                    <Box sx={{ ...classes.contentItem }}>
                        ...
                        >
                            ...
                            <Box sx={{ ...classes.buttonsContainer }}>
                                <Link href={textContent.Contact.CtaButton.link}>
                                    <Button
                                        variant={
                                            textContent.Contact.CtaButton
                                                .variant as any
                                        }
                                        color={
                                            textContent.Contact.CtaButton
                                    ...
                                    >
                                        {returnLocaleText(
                                            textContent.Contact.CtaButton.text,
                                        )}
                                    </Button>
                                </Link>
                            </Box>
                        ...
                        >
                            <Box sx={{ ...classes.itemTextContainer }}>
                                <Typography
                                    ...
                                    fontFamily={CustomFonts.Gustavo}
                                >
                                    {returnLocaleText(textContent.Stores.title)}
                                </Typography>
                                <Typography variant="body1">
                                    {returnLocaleText(textContent.Stores.body)}
                                </Typography>
                            </Box>
                            <Box sx={{ ...classes.buttonsContainer }}>
                                <Link href={textContent.Stores.CtaButton.link}>
                                    <Button
                                        variant="contained"
                                        color="primary"
                                        sx={{ ...classes.button }}
                                    >
                                        {returnLocaleText(
                                            textContent.Stores.CtaButton.text,
                                        )}
                                    </Button>
                                </Link>
                            </Box>
