...
function ContentItem(props: { article: ArticleInterface }) {
...
export default function (props: { articles: ArticleInterface[] }) {
        ...
        <>
            ...
            >
                <Typography
                    ...
                    variant="h6"
                >
                    {returnLocaleText(TEXT.discover)}
                </Typography>
                <hr />
