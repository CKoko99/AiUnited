const PATHCONSTANTS = {
    ...
    QUOTES: {
        ...
        MEXICO: {
            INDEX: "/quotes/mexico",
            FORM: "/quotes/mexico#Mexico-quote",
        },
        MOTORCYCLE: {
            INDEX: "/quotes/motorcycle",
            FORM: "/quotes/motorcycle#Motorcycle-quote",
        },
        RENTER: {
            INDEX: "/quotes/renter",
            FORM: "/quotes/renter#Renter-quote",
        },
        SURETY: {
            INDEX: "/quotes/surety-bond",
            FORM: "/quotes/surety-bond#Surety-quote",
        },
        SR22: { INDEX: "/quotes/sr22", FORM: "/quotes/sr22#SR22-quote" },
        LIABILITY: {
            INDEX: "/quotes/liability",
            FORM: "/quotes/liability#Liability-quote",
        },
    },
    PRODUCTS: {
        INDEX: "/products",
    ...
    PAYMENTS: "/payments",
    PHONE: "tel:2814125227",
    PHONETEXT: "(281)-412-5227",
    ...
    BACKEND:
        process.env.NODE_ENV === "development"
            ...
            : "https://insurancehubbackend-uc3v53rceq-ue.a.run.app",
    BACKEND2:
        process.env.NODE_ENV === "development"
            ? "http://192.168.20.122:8081"
            : "https://spring-backend-uc3v53rceq-ue.a.run.app",
    STRAPI:
        process.env.NODE_ENV === "development"
            ? "http://localhost:1337"
            : "https://ai-united-strapi-uc3v53rceq-ue.a.run.app",
};
